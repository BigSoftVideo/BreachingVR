...
#region IL2CPP Support
    ...
    public partial class Deeplink
    {
        ...
        public static void GoToApp(
                ...
                string launchData)
        {
            if (callback == null || string.IsNullOrEmpty(viveportId) || string.IsNullOrEmpty(launchData))
            {
                throw new InvalidOperationException("callback == null || string.IsNullOrEmpty(viveportId) || string.IsNullOrEmpty(launchData)");
            }
                ...
                string branchName)
        {
            ...
            if (IntPtr.Size == 8)
            {
                Internal.Deeplink.GoToApp_64(goToAppIl2cppCallback, viveportId, launchData, branchName);
            }
            else
            {
                Internal.Deeplink.GoToApp(goToAppIl2cppCallback, viveportId, launchData, branchName);
            }
        }
